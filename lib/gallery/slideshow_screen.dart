      ...
      body: GestureDetector(
        ...
        child: Stack(
          ...
          children: [
            ...
            // Which picture of how many. Fades with the close button, so
            // the frame is bare again three seconds after the last touch —
            // the whole point of a slideshow on a propped-up tablet.
            if (image != null)
              Positioned(
                bottom: 20,
                left: 0,
